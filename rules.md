...
#### Start Date
March 29, 2021. [PUT YOUR DATE HERE]
...
1. To increase the chances of success, add a link to each of the day posts in the [log](log.md). It can be a link to a commit on GitHub, a link to a blog post
